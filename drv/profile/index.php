<?php 
  ...
  if(isset($_SESSION['did'])) {
    $did=$_SESSION['did'];
    $a1="SELECT * FROM driver WHERE `did`=$did;";
    ...
    $uphone=$c1['dphone'];
    $ugender=$c1['dgender'];  
    $a2="SELECT COUNT(tripid) FROM trip WHERE did=$did;";
    $b2=mysqli_query($conn,$a2);
    $c2=$b2->fetch_assoc();
    $rides=$c2['COUNT(tripid)'];
  ...
  <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                  <a class="nav-link active bold" aria-current="page" href="../phpfiles/requests.php">Requested</a>
              </li>
              <li class="nav-item">
